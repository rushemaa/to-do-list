...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _style_css__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./style.css */ \"./src/style.css\");\n/* harmony import */ var _assets_arrow_repeat_svg__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./assets/arrow-repeat.svg */ \"./src/assets/arrow-repeat.svg\");\n/* harmony import */ var _assets_three_dots_vertical_svg__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./assets/three-dots-vertical.svg */ \"./src/assets/three-dots-vertical.svg\");\n\n\n\n\nconst simpleTasks = [\n  { description: 'wash the dishes', completed: false, index: 1 },\n  { description: 'complete To Do List project', completed: false, index: 2 },\n];\nconst toDoList = (listData) => {\n  let lists = `<li class=\"li-header\"><h2>Today's To Do </h2><img class=\"right-icons\" cl src=\"${_assets_arrow_repeat_svg__WEBPACK_IMPORTED_MODULE_1__}\"></li>`;\n  lists\n    += '<li class=\"add-input\"><form> <input id=\"new-item\" class=\"new-item\" placeholder=\"Add to your list...\" type=\"text\"> <input id=\"submit-new-item\" type=\"submit\" tabindex=\"-1\" value=\"\" title=\"click this or press enter to submit\" class=\"icon-return\"> </form></li>';\n  listData.forEach((list) => {\n    const { description } = list;\n    lists += `<li class='tasks'><div><input class='checkboxs' type='checkbox' /><textarea>${description}</textarea></div> <img class=\"right-icons\" src=\"${_assets_three_dots_vertical_svg__WEBPACK_IMPORTED_MODULE_2__}\"></li>`;\n  });\n  lists\n    += '<li class=\"btn-clear\"><button type=\"button\">Clear all completed</button></li>';\n  return lists;\n};\n\ndocument.querySelector('ul').innerHTML = toDoList(simpleTasks);\n\n\n//# sourceURL=webpack://webpack-demo/./src/index.js?");
